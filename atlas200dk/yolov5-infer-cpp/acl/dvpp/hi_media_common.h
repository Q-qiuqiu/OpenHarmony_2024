...
#ifndef HI_MEDIA_COMMON_H_
#define HI_MEDIA_COMMON_H_
...
typedef enum {
    HI_ERR_INVALID_DEV_ID = 1, // invalid device ID
    HI_ERR_INVALID_CHN_ID = 2, // invalid channel ID
    HI_ERR_ILLEGAL_PARAM = 3, // at least one parameter is illegal
                              // eg, an illegal enumeration value
    HI_ERR_EXIST         = 4, // resource exists
    HI_ERR_UNEXIST       = 5, // resource unexists

    HI_ERR_NULL_PTR      = 6, // using a NULL pointer

    HI_ERR_NOT_CFG    = 7, // try to enable or initialize system, device
                           // or channel, before configure attribute

    HI_ERR_NOT_SUPPORT   = 8, // operation or type is not supported by NOW
    HI_ERR_NOT_PERM      = 9, // operation is not permitted
                              // eg, try to change static attribute
    HI_ERR_INVALID_PIPE_ID = 10, // invalid pipe ID
    HI_ERR_INVALID_GRP_ID  = 11, // invalid stitch group ID
    ...
    HI_ERR_NOT_READY  = 16, // System is not ready,maybe not initialized or
    ...
    HI_ERR_INVALID_LAYER_ID = 22, // invalid layer ID
    HI_ERR_NOT_ENABLE       = 23,
    HI_ERR_NOT_DISABLE     = 24,
    HI_ERR_NOT_START       = 25,
    HI_ERR_NOT_STOP        = 26,

    HI_ERR_NOT_BINDED      = 27,
    HI_ERR_BINDED          = 28,

    HI_ERR_REG             = 29, // regiter error
    HI_ERR_BUTT          = 63, // maximum code, private error code of all modules
                               // must be greater than it
} hi_errno;

typedef enum {
    HI_ERR_LEVEL_DEBUG = 0,  // debug-level
    HI_ERR_LEVEL_INFO,       // information
...
#endif // #ifndef HI_MEDIA_COMMON_H_
