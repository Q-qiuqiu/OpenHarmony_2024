...
```
docker build -t mobilenetv3:latest .
```
...
post请求访问地址为http://192.168.137.100:5001/mbclassify,请求体为form-data,key为image，value为图片

分类成功返回示例：

```
[
    {'label': 162, 'confidence': 0.6748046875, 'class': 'beagle'
    },
    {'label': 166, 'confidence': 0.1163330078125, 'class': 'Walker hound, Walker foxhound'
    },
    {'label': 167, 'confidence': 0.11187744140625, 'class': 'English foxhound'
    },
    {'label': 161, 'confidence': 0.03704833984375, 'class': 'basset, basset hound'
    },
    {'label': 208, 'confidence': 0.0039215087890625, 'class': 'Labrador retriever'
    }
]
```